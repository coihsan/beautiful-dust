...
export default function AstroJS() {
  return (
    <a
      ...
      className="w-full h-60 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-purple-900 via-purple-950 to-bunker-950 rounded-lg p-5 group overflow-hidden border border-bunker-800"
    >
