  ...
  return (
    <div className="w-full h-60 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-purple-900 via-purple-950 to-zinc-900 rounded-lg p-5 group overflow-hidden">
      <div className="flexJustifyCenter flex-col">
        <div className="flexJustifyCenter flex-col translate-y-[30%] group-hover:translate-y-[0%] transition-transform ease-in-out">
          <Image
        ...
        <Image
          className="translate-y-[150%] group-hover:translate-y-[0%] transition-transform ease-in-out"
